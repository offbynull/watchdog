...
import com.offbynull.watchdog.antplugin.InstrumentTask;
import java.io.File;
...
public class InstrumentTaskTest {
    ...
    public void mustInstrumentClasses() throws Exception {
        ...
        try {
            ...
            // write out
            File inputClass = new File(inputDir, "TightLoopTest.class");
            ...
            // read back in
            File outputClass = new File(outputDir, "TightLoopTest.class");
