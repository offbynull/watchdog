 ...
 */
package com.offbynull.watchdog.instrumenter.testhelpers;
...
public final class TestUtils {
    ...
    /**
     * Equivalent to calling {@code loadClassesInZipResourceAndInstrument(path, new InstrumentationSettings(MarkerType.CONSTANT))}.
    ...
    public static URLClassLoader loadClassesInZipResourceAndInstrument(String path) throws IOException {
        return loadClassesInZipResourceAndInstrument(path, new InstrumentationSettings(MarkerType.CONSTANT));
    }
    
    /**
     * Equivalent to calling
     * {@code loadClassesInZipResourceAndInstrument(path, new InstrumentationSettings(MarkerType.CONSTANT), x -> x)}.
     * @param path path of zip resource
